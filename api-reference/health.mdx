...
Grantiva exposes several health endpoints. None require authentication.
...
A static banner confirming you reached the API.

```json
{
  "message": "Grantiva API is running",
  "version": "1.0.0",
  "documentation": "https://docs.grantiva.io",
  "status": "healthy"
}
```
