...
- **100% of limit reached** — You'll receive a second notification. A **7-day grace period** begins automatically. Devices already in your fleet keep working. New devices can still attest during the grace period, giving you time to upgrade.
- **After the grace period** — If you haven't upgraded, new device onboarding pauses until you do. Existing attested devices are never affected — they continue working regardless.
...
No. Existing attested devices always keep working. When you hit your limit, a 7-day grace period starts automatically — new devices can still attest during this window. After the grace period, new device onboarding pauses until you upgrade, but your existing users are never affected.
