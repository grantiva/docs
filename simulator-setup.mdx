...
This page is about running the **Grantiva SDK** in the iOS Simulator. For provisioning and tearing down simulators with the CLI — capacity limits, leases, and cleanup — see [Simulator management](/cli/simulators).

## Why App Attest doesn't work in the Simulator
...
<CardGroup cols={2}>
  ...
  <Card title="Simulator management" icon="terminal" href="/cli/simulators">
    Provision, share, and reclaim simulators with the Grantiva CLI.
  </Card>
  <Card title="Testing" icon="vial" href="/sdk/testing">
    Mock attestation and test SDK integration without a device.
  </Card>
</CardGroup>
