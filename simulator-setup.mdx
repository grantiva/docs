...
} catch GrantivaError.simulatorNotConfigured {
    // apiKey not provided — catch this in development
...
<CardGroup cols={2}>
  <Card title="Back to Quick Start" icon="rocket" href="/quickstart">
    Continue setting up Grantiva on a real device.
  </Card>
  <Card title="Error handling" icon="triangle-exclamation" href="/sdk/error-handling">
    Handle GrantivaError.simulatorNotConfigured and other errors.
  </Card>
</CardGroup>
