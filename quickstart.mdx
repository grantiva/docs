...
Sign up at [grantiva.io/login](https://grantiva.io/login) with email, GitHub, or Google. Then add your first app from the dashboard — you'll need your Apple Team ID and Bundle ID.
