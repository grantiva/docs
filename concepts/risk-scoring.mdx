...
| Plan | What you get |
|------|-------------|
| Free / Pro | Risk category only: **Trusted**, **Suspicious**, or **Blocked** |
| Business / Enterprise | Full 0–100 numeric risk score + category |

<Callout type="info">
On Free and Pro plans, `risk_score` is `null` in the attestation JWT. Use `risk_category` to make access decisions. See [Backend Verification](/backend-verification) for details.
</Callout>

## Score ranges

On Business and Enterprise plans, the numeric score maps to these levels:
