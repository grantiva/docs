...
- **App** — a registered application with its own APNs `.p8` credentials and API keys. Push apps are provisioned by Grantiva and appear in your org dashboard (contact [support](mailto:support@grantiva.io) to register one). APNs credentials are stored AES-256-GCM encrypted and can be added or rotated after registration.
